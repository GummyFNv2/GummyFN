...
if "-beta" in sys.argv:
    githuburl = "https://raw.githubusercontent.com/GummyFNv2/GummyFN/beta/"
else:
    githuburl = "https://raw.githubusercontent.com/GummyFNv2/GummyFN/master/"

if CheckUpdate("auto.py", githuburl):
    print("auto.py got updated. Run auto again...\n")
    os.chdir(os.getcwd())
